        ...
        <div className="">
          ...
          <div className="flex space-x-10 mt-7 justify-end md:mb-0 mb-4">
            <div
              ...
              className="font-bold font-roboto px-10 py-2 border-[#000000]  border rounded-md text-[#000000] hover:border-green-1 hover:cursor-pointer transition-all ease-in-out duration-150 hover:bg-opacity-90 hover:shadow-md hover:shadow-[#ffc792] hover:bg-green-1 hover:text-white">
              Zurück
            </div>
            ...
            <div
              ...
              className="font-bold font-roboto px-10 py-2 border-green-1 border rounded-md bg-green-1 text-white hover:cursor-pointer transition-all ease-in-out duration-150 hover:bg-opacity-90 hover:shadow-md hover:shadow-[#ffc792] hover:text-green-1 hover:bg-white">
              Weiter
            </div>
          </div>
        </div>
