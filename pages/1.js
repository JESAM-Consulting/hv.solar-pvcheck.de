          ...
          >
            <div className="lg:px-16 lg:py-6 lg:pb-0 md:pt-10 relative ">
              ...
              <div
                ...
                className={`bg-green-1 mb-4 mt-4 mx-6 lg:hidden lg:opacity-0 md:mt-8 z-50 backButtonM relative group hover:cursor-pointer  transition-all ease-in-out duration-150 hover:bg-opacity-90 hover:shadow-md hover:shadow-[#ffc792] flex justify-center items-center space-x-3 font-roboto rounded-md py-2.5 md:w-32 w-10 text-white text-center`}
              >
              ...
              <div
                ...
                } backButton group hover:cursor-pointer  transition-all ease-in-out duration-150 hover:bg-opacity-90 hover:shadow-md hover:shadow-[#ffc792] justify-center items-center space-x-3 font-roboto rounded-md py-2.5 md:w-32 w-10 text-white text-center`}
              >
                ...
                >
                  ...
                  <div className="text-xs mt-10 w-full">
                    ...
                    <div className="flex justify-between">
                      <span>
                        Ersparnis gesamt:{" "}
                        <strong>49.715 € über 20 Jahre</strong>
                      </span>
                      <span className="font-bold"></span>
                    </div>
                  </div>
